...
class paramter {
    ...
    class func BankTransfer(oederId:String,ImageName:String) ->Parameters{
    ...
    class func MakeFavorite(customer:Bool,productId:String)->Parameters {
        let parms = ["customer":customer,"productID":productId] as [String:Any]
        return parms
    }
    ...
    class func productID(productID:String)->Parameters {
    ...
    class func shippingOrder (street1:String,street2:String,city:String,state:String,country:String,zip:String,notes:String,phone:String,addId:String?)->Parameters{
        let parms = ["shipping":["address":["street1":street1,"street2":street2,"city":city,"country":country,"state":state,"zip":zip,"notes":notes],"phone":phone],"addressID":addId ?? "null"] as [String : Any]
        return parms
    }
    ...
    class func AddToCart(customer:Bool,productID:String,quantity:Int)->Parameters {
        let parms = ["productID":productID,
                     "quantity":quantity,
        "customer":customer] as [String:Any]
return parms
    }

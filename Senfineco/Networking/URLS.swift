...
class URLS {
    ...
    static let filter = main + "api/v1.0/filter/dropdown"

    static let main = "https://senfinecoo.herokuapp.com/"
...
static let category = main + "api/v1.0/categories/categories"
    static let ProductInOneCategoty = main + "api/v1.0/product/0/0/"
    ...
    static let sendContactMessage = main + "api/v1.0/user/contact"
    ...
    static let cart = main + "api/v1.0/cart/"
